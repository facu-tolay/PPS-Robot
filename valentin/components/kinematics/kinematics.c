...
void calculo_rompensacion_rotacional(float velocidades_lineales_reales[VELOCITY_VECTOR_SIZE])
{
    ...
    {
        velocidades_lineales_reales[2] = velocidades_lineales_reales[2] + (desplazamiento_rot_accum * 3.35); // se compensa la rotacion en base a cuanto desplazamiento rotacional se detecte
    }
}
